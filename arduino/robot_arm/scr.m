...
for i=1:n
    ...
    [tof_dist,t(i)]=data_stream_read_mex(data_stream_ptr,1,1);  
    [sonar_dist,t(i)]=data_stream_read_mex(data_stream_ptr,2,1);
    [meas,t(i)]=data_stream_read_mex(data_stream_ptr,3,9);
